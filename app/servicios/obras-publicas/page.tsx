            ...
            <Stack gap="md">
              <Paper 
                ...
                <Stack align="center" gap="md" style={{ position: 'relative', padding: '2rem', zIndex: 2 }}>
                  <Box style={{
                    ...
                    <IconCurrencyDollar size={30} color="white" />
                  </Box>
                  <Text fw={700} size="2.5rem" c="white" style={{ 
                    textShadow: '0 2px 10px rgba(0,0,0,0.2)' 
                  }}>30%</Text>
                  <Text size="lg" c="rgba(255,255,255,0.9)" fw={600}>Ahorro en costos de gestión</Text>
                </Stack>
              </Paper>
              ...
              <Paper 
                ...
                <Stack align="center" gap="md" style={{ position: 'relative', padding: '1.5rem', zIndex: 2 }}>
                  ...
                  <Text size="md" c="gray.6" fw={500}>Transparencia garantizada</Text>
                </Stack>
              </Paper>
            </Stack>
          </Grid.Col>
